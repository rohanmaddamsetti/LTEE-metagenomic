...
xticks = [10000*i for i in range(0,7)]
xticklabels = ["" for i in range(0,7)]
...
yticks = [1000*2*i for i in range(0,6)]
yticklabels = ['%dk' % (i*2) for i in range(0,6)]
yticklabels[0] = '0'
fixation_time_axis.set_yticks(yticks)
fixation_time_axis.set_yticklabels(yticklabels)

xticks = [10000*i for i in range(0,7)]
xticklabels = ['%dk' % (10*i) for i in range(0,7)]
xticklabels[0] = '0'
...
population_colors = { nonmutator_populations[i] : parse_file.nonmutator_line_colors[i] for i in range(0,len(nonmutator_populations)) } 

for i in range(0,len(mutator_populations)):
...
for population in parse_file.complete_nonmutator_lines:
    ...
    if population in list(origin_fixation_times.keys()) and (population not in masked_populations):
...
for population in parse_file.complete_nonmutator_lines:
    ...
    if population in list(origin_fixation_times.keys()):
        num_pops+=1
