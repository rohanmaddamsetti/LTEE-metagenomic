...
axes = []
for metapopulation_idx in range(0,2):
    axes.append([])
    for population_idx in range(0,6):
...
for metapopulation_idx in range(0,2):
    for population_idx in range(0,6):
        ...
        clone_mutation_Ls = []
        for clone_idx in range(0,len(clone_avg_depth_times)):
        ...
        for mutation_idx in range(0,len(mutations)):
            ...
            for clone_idx in range(0,len(clone_times)):
        ...
        #time to plot!
        for clone_idx in range(0,len(clone_mutation_Ls)):
