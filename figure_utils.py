...
time_xticks = [10000*i for i in range(0,7)]
time_xticklabels = ['%dk' % (10*i) for i in range(0,7)]
time_xticklabels[0] = '0'

small_time_xticks = [20000*i for i in range(0,4)]
small_time_xticklabels = ['%dk' % (20*i) for i in range(0,4)]
