...
generation_ticks = [10000*i for i in range(0,7)]
generation_ticklabels = ['%dk' % (10*i) for i in range(0,7)]
generation_ticklabels[0] = '0'

generation_ticks = [5000*i for i in range(0,13)]
generation_ticklabels = ['%dk' % (5*i) for i in range(0,13)]
...
focal_axes = []
for i in range(0,len(focal_populations)):
...
remaining_axes = []
for i in range(0, len(remaining_populations)):
    ...
    if i==(len(remaining_populations)-1):
        remaining_axis.set_xticks([i*10000 for i in range(0,7)])
...
for idx in range(0,len(remaining_populations)):
